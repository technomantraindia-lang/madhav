        ...
        '<nav class="nav-menu" id="nav-menu">' +
          '<ul class="nav-list">' +
            ...
            '<li class="has-dropdown">' +
              '<a href="index.html#products" class="nav-link" id="nav-products">Products <span class="arrow">&#9662;</span></a>' +
              '<ul class="dropdown">' +
                '<li><a href="#" id="nav-pvc">PVC Compound</a></li>' +
                '<li><a href="#" id="nav-rp">RP Compound</a></li>' +
                '<li><a href="#" id="nav-mb">PVC Masterbatches</a></li>' +
                '<li><a href="#" id="nav-sp">Special Compounds</a></li>' +
              '</ul>' +
            '</li>' +
            '<li class="has-dropdown">' +
              ...
              '</ul>' +
            '</li>' +
            '<li><a href="index.html#quality" class="nav-link" id="nav-quality">Quality</a></li>' +
            '<li class="has-dropdown">' +
      ...
      '<div class="footer-grid">' +
        ...
        '<div class="footer-col">' +
          ...
          '<ul>' +
            ...
            '<li><a href="index.html#products" id="foot-products">Our Products</a></li>' +
            '<li><a href="index.html#applications" id="foot-apps">Applications</a></li>' +
            '<li><a href="index.html#quality" id="foot-quality">Quality</a></li>' +
        ...
        '<div class="footer-col">' +
          '<h4>PRODUCTS</h4>' +
          '<ul>' +
            '<li><a href="#" id="foot-pvc">PVC Compound</a></li>' +
            '<li><a href="#" id="foot-rp">RP Compound</a></li>' +
            '<li><a href="#" id="foot-mb">PVC Masterbatches</a></li>' +
            '<li><a href="#" id="foot-sp">Special Compounds</a></li>' +
          '</ul>' +
        '</div>' +
