...
(function () {
  ...
  var APPS = {
    ...
    'molding-others': {
      ...
      examples: [
        ...
        { img: 'Wire & Cables.png', label: 'Grips & Handles' },
        { img: 'Untitled design/1.png', label: 'Seals & Gaskets' },
        { img: 'Wide Range of Applications 1.png', label: 'Wire Harness Covers' },
        { img: 'Untitled design/4.png', label: 'Molded Accessories' },
  ...
  function applyApp(key) {
    ...
    data.examples.forEach(function (ex, i) {
      if (!exampleNodes[i]) return;
      var img = exampleNodes[i].querySelector('img');
      var h3 = exampleNodes[i].querySelector('h3');
      if (img) {
        img.src = ex.img;
        img.alt = ex.label;
      }
